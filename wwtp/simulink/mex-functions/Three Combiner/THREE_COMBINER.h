...
#define ANCHURAPUERTO3ENTRADA		(1+NUMESTADOSMODASM1)		// Caudal + concentraciones entrada2
...
#define Q_IN3				(*uPtrs2[0])
#define SS_IN3				(*uPtrs2[1])
#define SO_IN3				(*uPtrs2[2])
#define SI_IN3				(*uPtrs2[3])
#define SNO_IN3				(*uPtrs2[4])
#define SNH_IN3				(*uPtrs2[5])
#define SND_IN3				(*uPtrs2[6])
#define SALK_IN3			(*uPtrs2[7])
#define XI_IN3				(*uPtrs2[8])
#define XS_IN3				(*uPtrs2[9])
#define XBH_IN3				(*uPtrs2[10])
#define XBA_IN3				(*uPtrs2[11])
#define XP_IN3				(*uPtrs2[12])
#define XND_IN3				(*uPtrs2[13])
#define XIN_IN3				(*uPtrs2[14])